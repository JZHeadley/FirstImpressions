...
import com.jzheadley.firstimpressions.repository.JobRepository;
import com.jzheadley.firstimpressions.repository.search.JobSearchRepository;
...
public class JobResourceIntTest {
    ...
    private static final String DEFAULT_JOB_LINK = "AAAAAAAAAA";
    private static final String UPDATED_JOB_LINK = "BBBBBBBBBB";
     ...
     *
     * @see com.jzheadley.firstimpressions.repository.search.JobSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createJob() throws Exception {
        ...
        assertThat(testJob.getJobLink()).isEqualTo(DEFAULT_JOB_LINK);
    ...
    public void getAllJobs() throws Exception {
        ...
        restJobMockMvc.perform(get("/api/jobs?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].jobLink").value(hasItem(DEFAULT_JOB_LINK.toString())))
    ...
    public void getJob() throws Exception {
        ...
        restJobMockMvc.perform(get("/api/jobs/{id}", job.getId()))
            ...
            .andExpect(jsonPath("$.jobLink").value(DEFAULT_JOB_LINK.toString()))
    ...
    public void updateJob() throws Exception {
        ...
        assertThat(testJob.getJobLink()).isEqualTo(UPDATED_JOB_LINK);
    ...
    public void searchJob() throws Exception {
        // Initialize the database
        jobRepository.saveAndFlush(job);
        when(mockJobSearchRepository.search(queryStringQuery("id:" + job.getId())))
