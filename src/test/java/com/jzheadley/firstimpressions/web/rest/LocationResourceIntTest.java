...
import com.jzheadley.firstimpressions.repository.LocationRepository;
import com.jzheadley.firstimpressions.repository.search.LocationSearchRepository;
...
public class LocationResourceIntTest {
    ...
    private static final Integer DEFAULT_BUILDING_NUMBER = 1;
    private static final Integer UPDATED_BUILDING_NUMBER = 2;
     ...
     *
     * @see com.jzheadley.firstimpressions.repository.search.LocationSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getBuildingNumber()).isEqualTo(DEFAULT_BUILDING_NUMBER);
    ...
    public void updateLocation() throws Exception {
        ...
        Location testLocation = locationList.get(locationList.size() - 1);
        assertThat(testLocation.getBuildingNumber()).isEqualTo(UPDATED_BUILDING_NUMBER);
